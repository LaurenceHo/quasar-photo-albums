/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6ff6551598dbd4f7d181b9bec7622f9f)
// Runtime types generated with workerd@1.20251118.0 2025-10-20 nodejs_compat
declare namespace Cloudflare {
    interface GlobalProps {
        mainModule: typeof import("./src/d1/worker");
    }
    interface Env {
        ...
        PHOTO_ALBUMS_TABLE_NAME: string;
        PHOTO_ALBUM_TAGS_TABLE_NAME: string;
        PHOTO_USER_PERMISSION_TABLE_NAME: string;
        DATA_AGGREGATIONS_TABLE_NAME: string;
        TRAVEL_RECORDS_TABLE_NAME: string;
        WORKER_URL: string;
        WORKER_SECRET: string;
        CDK_DEFAULT_ACCOUNT: string;
        PHOTO_ALBUMS_STREAM_ARN: string;
...
declare namespace NodeJS {
    interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PROD_WORKER_SECRET" | "AWS_ACCESS_KEY_ID" | "AWS_SECRET_ACCESS_KEY" | "AWS_REGION_NAME" | "GOOGLE_PLACES_API_KEY" | "VITE_GOOGLE_CLIENT_ID" | "JWT_SECRET" | "DEVELOPMENT" | "ALBUM_URL" | "VITE_IMAGEKIT_CDN_URL" | "AWS_S3_BUCKET_NAME" | "PHOTO_ALBUMS_TABLE_NAME" | "PHOTO_ALBUM_TAGS_TABLE_NAME" | "PHOTO_USER_PERMISSION_TABLE_NAME" | "DATA_AGGREGATIONS_TABLE_NAME" | "TRAVEL_RECORDS_TABLE_NAME" | "WORKER_URL" | "WORKER_SECRET" | "CDK_DEFAULT_ACCOUNT" | "PHOTO_ALBUMS_STREAM_ARN" | "D1_PHOTO_ALBUMS_WORKER" | "DEV_PHOTO_ALBUMS_DB_NAME" | "DEV_PHOTO_ALBUMS_DB_ID" | "DEV_WORKER_SECRET">> { }
}
